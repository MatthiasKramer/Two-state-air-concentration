...
-L48: the boundary layer thickness **\03B4** is computed empirically, as per Fig. 4c in  [Kramer and Valero](https://doi.org/10.1017/jfm.2023.440) (2023). Please estimate delta from velocity measurements, if available.
